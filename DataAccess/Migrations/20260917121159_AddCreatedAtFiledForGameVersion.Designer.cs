...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260917121159_AddCreatedAtFiledForGameVersion")]
    partial class AddCreatedAtFiledForGameVersion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Data.Entities.TradeOffer", b =>
                {
                    ...
                    b.HasIndex("ReceiverInventoryItemId");

                    b.HasIndex("SenderId");

                    b.HasIndex("SenderInventoryItemId");
            ...
            modelBuilder.Entity("DataAccess.Data.Entities.TradeOffer", b =>
                {
                    ...
                    b.HasOne("DataAccess.Data.Entities.InventoryItem", "ReceiverInventoryItem")
                        .WithMany()
                        .HasForeignKey("ReceiverInventoryItemId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("DataAccess.Data.Entities.InventoryItem", "SenderInventoryItem")
                        .WithMany()
                        .HasForeignKey("SenderInventoryItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Receiver");

                    b.Navigation("ReceiverInventoryItem");

                    b.Navigation("Sender");

                    b.Navigation("SenderInventoryItem");
                });
