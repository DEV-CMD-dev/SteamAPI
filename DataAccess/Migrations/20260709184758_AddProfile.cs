        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserVisibility = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "Id", "CoverImage", "Description", "DeveloperId", "Price", "ReleaseDate", "SystemRequirements", "Title" },
                values: new object[,]
                {
                    { 1, "https://example.com/covers/cs2.jpg", "Tactical shooter.", null, 0.00m, new DateTime(2023, 9, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), "Windows 10, 8GB RAM", "Counter-Strike 2" },
                    { 2, "https://example.com/covers/neon.jpg", "Cyberpunk RPG.", null, 29.99m, new DateTime(2026, 5, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Windows 11, 16GB RAM", "Neon City 2026" },
                    { 3, "https://example.com/covers/elden.jpg", "Rise, Tarnished.", null, 59.99m, new DateTime(2022, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Windows 10, RTX 2060", "Elden Ring" }
                });
            ...
            migrationBuilder.InsertData(
                table: "GameVersions",
                columns: new[] { "Id", "GameId", "PatchNotes", "Version" },
                values: new object[,]
                {
                    { 1, 1, "Initial release.", "v1.0" },
                    { 2, 1, "Fixed smoke grenades.", "v1.1" },
                    { 3, 2, "Early Access Launch.", "v0.9" },
                    { 4, 3, "Colosseum update.", "v1.10" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "https://example.com/screenshots/cs2_1.jpg" },
                    { 2, 1, "https://example.com/screenshots/cs2_2.jpg" },
                    { 3, 2, "https://example.com/screenshots/neon_1.jpg" },
                    { 4, 3, "https://example.com/screenshots/elden_1.jpg" }
                });
