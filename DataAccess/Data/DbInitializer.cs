...
namespace DataAccess.Data
{
    public static class DbInitializer
    {
        ...
        {
            modelBuilder.Entity<Developer>().HasData(new List<Developer>()
            {
                new() { Id = 1, Name = "Valve" },
                new() { Id = 2, Name = "IndieStudio" },
                new() { Id = 3, Name = "FromSoftware" }
            });
            ...
            {
                new() { Id = 1, Name = "Valve" },
                new() { Id = 2, Name = "IndiePublisher" },
                new() { Id = 3, Name = "Bandai Namco" }
            });
